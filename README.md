...
```
$ wget https://github.com/Freechains/README/releases/download/v0.7.5/install-v0.7.5.sh

# choose one:
$ sh install-v0.7.5.sh .                    # either unzip to current directory (must be in the PATH)
$ sudo sh install-v0.7.5.sh /usr/local/bin  # or     unzip to system  directory
```
