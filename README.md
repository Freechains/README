...
```
$ wget https://github.com/Freechains/README/releases/download/v0.7.3/install-v0.7.3.sh

# choose one:
$ sh install-v0.7.3.sh .                    # either unzip to current directory (must be in the PATH)
$ sudo sh install-v0.7.3.sh /usr/local/bin  # or     unzip to system  directory
```
